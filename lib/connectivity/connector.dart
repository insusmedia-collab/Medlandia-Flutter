...
int genId(){
  return int.parse("${new Random().nextInt(100)}${DateTime.now().microsecondsSinceEpoch.toString()}");
}
...
static Future<BaseMemberModel?> loadUser({required int id}) async {
  Map<String, dynamic>? user = await call(null, {'func': 'getUser', 'p1': id.toString()});
