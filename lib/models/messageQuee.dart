...
class MessageQuee {
  ...
  MessageQuee({required this.messageUniqId, required this.type, this.subject = ""});

  MessageQuee copy() {
    MessageQuee q = MessageQuee(messageUniqId: messageUniqId, type: type);
    q.subject = subject;
  ...
  void replaceAllUsers(List<Recipient> newUsers) {
    _users.clear();
  ...
  MessageQuee appendMessage(Message message) {
